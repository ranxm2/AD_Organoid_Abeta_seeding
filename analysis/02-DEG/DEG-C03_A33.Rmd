...
subtitle: "CTRL(C03) vs AD in Vehicle condition"
author: "Ximing Ran"
date: "2025-04-25"
output:
  pdf_document:
...
knitr::opts_chunk$set(
  ...
  warning = FALSE,
  message = FALSE,
  fig.path = "./results/DEG-C03_A33/Analysis_figure/"
)
...
result_folder_all = './results/DEG-C03_A33'
...
rownames(filter_sample_info) <- sample_list_raw$Label[c(1:3, 7:9)]
